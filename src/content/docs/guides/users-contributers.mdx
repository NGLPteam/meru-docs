...
2. To get to the user list, go to **Manage** in the main navigation and click on **Users**.
    ...
    <Badge text="Note" variant="note" /> _The user list is visible to all users, but only those with `global_admin` privileges can edit user accounts._
...
### Manage Associated Communities

<Steps>

1. From the main user list, click on the name of the user whose associated communities you’d like to update.
2. In the left side of the user dashboard, make sure the **Communities** tab is selected.

</Steps>

#### Add a New Associated Community
...
#### Update an Existing Associated Community

<Steps>

1. Hover over the community name that you would like to update.
2. To remove the associated community, click on the button with the trash icon, and click **Delete**.
...
### Manage Associated Collections

<Steps>

1. From the main user list, click on the name of the user whose associated collections you’d like to update.
2. In the left side of the user dashboard, make sure the **Collections** tab is selected.

</Steps>

#### Add a New Associated Collection
...
#### Update an Existing Associated Collection

<Steps>

1. Hover over the collection name that you would like to update.
2. To remove the associated collection, click on the button with the trash icon, and click **Delete**.
...
1. From the main user list, click on the name of the user whose associated items you’d like to update.
2. In the left side of the user dashboard, make sure the **Items** tab is selected.

</Steps>

#### Add a New Associated Item
...
#### Update an Existing Associated Item

<Steps>

1. Hover over the item name that you would like to update.
2. To remove the associated item, click on the button with the trash icon, and click **Delete**.
...
2. To remove the contribution, click on the button with the trash icon, and click **Delete**.
3. To update the role and position details for the user within that contribution, click on the button with the pencil icon. Make the desired changes and click **Save**.
4. Click on the community name to navigate to that community's detail page.
