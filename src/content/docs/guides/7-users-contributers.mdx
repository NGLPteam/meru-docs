...
_Creating and removing users, as well as assigning administation privileges, is handled through the [Keycloak user dashboard](/guides/2-keycloak#creating-users), or users can register their own account directly from the Meru login screen. This section focuses on managing users after they've been created—resetting passwords, updating user details, and managing associated communities, collections, or items._
...
2. To get to the user list, go to **Manage** in the main navigation and click on **Users**.
   ...
   <Badge text="Note" variant="note" /> _Only those with `global_admin`
   privileges can edit user accounts._
...
<Badge text="Note" variant="note" /> *Here is what those details will look like
on the contributer details page:*
...
<Badge text="Note" variant="note" /> *This will navigate you out of admin and to
the public contributor page on the frontend.*
...
- **Quick edit drawer** — _useful for making simple updates to contributor details._
- **Full contributor page** — _allows editing details as well as managing collection and item contributions._
