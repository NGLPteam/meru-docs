...
<Badge text="Note" variant="note" /> _Some entities will not be selectable. You will still be able to click on the right arrow to view their child entities._
...
<Badge text="Note" variant="note" /> _Schema is defined when the entity is harvested. See the [Harvesting page](/guides/8-harvesting) for a detailed explanation._
