...
*This guide walks through how to create and update  links for entities.*
...
4. If the linked entity is a descendent, select **Contains** and if it is a non descended entity, select **reference**.
5. Click **save**.
